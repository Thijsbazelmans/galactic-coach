import type { NewsEffect, Stats } from './types';
...
export interface SpeciesDef {
  ...
  name: string;
  mods: Partial<Stats>;
  /** hard ceiling per stat — species define what's reachable */
  caps: Stats;
...
export const SPECIES: SpeciesDef[] = [
  {
    ...
    name: 'Terran',
    mods: {},
    caps: { phy: 80, men: 82, off: 80, def: 80 },
    heightRange: [185, 212],
    weightRange: [80, 115],
  ...
  },
  {
    ...
    name: 'Hexabrach',
    mods: { off: 6, def: 8 },
    caps: { phy: 82, men: 86, off: 94, def: 96 },
    heightRange: [195, 225],
    weightRange: [100, 140],
  ...
  },
  {
    id: 'dodecapede',
    name: 'Dodecapede',
    mods: { phy: 8, off: 2, def: -4 },
    caps: { phy: 99, men: 90, off: 86, def: 78 },
    heightRange: [170, 195],
    weightRange: [58, 88],
  ...
  },
  {
    id: 'lithoid',
    name: 'Lithoid',
    mods: { phy: 8, def: 10, off: -12 },
    caps: { phy: 99, men: 80, off: 55, def: 99 },
    heightRange: [178, 205],
    weightRange: [140, 200],
    desc: 'Sentient rock. Stronger than everyone, forever. Offense is a rumor to them.',
    posNote: 'centers',
    rarity: 1,
  },
  {
    id: 'luminar',
    name: 'Luminar',
    mods: { off: 12, men: 6, phy: -10 },
    caps: { phy: 58, men: 96, off: 99, def: 70 },
    heightRange: [190, 220],
    weightRange: [40, 62],
...
// ---- training methods: they grant XP; the coach spends the level-ups ------
...
export const TRAINING_TYPES: TrainingDef[] = [
  ...
  },
  {
    ...
    desc: 'Shooting drills over a small captive black hole. Lose the ball, lose it forever.',
    xp: [6, 10],
  },
  {
    id: 'laser',
    name: 'LASER DODGING',
    desc: 'The training lasers are set to "sting". Lessons arrive quickly.',
    xp: [10, 15],
  },
  {
    id: 'holofilm',
    name: 'HOLO-FILM STUDY',
    desc: "Three hours in the holodeck watching last week's mistakes at life size.",
    xp: [10, 15],
  },
  {
    id: 'mascot',
    name: 'MASCOT SPARRING',
    desc: 'Three rounds against Boulder, the Lithoid mascot. Boulder does not go easy.',
    xp: [12, 18],
  },
];
...
export interface EventDef {
  ...
  auto?: NewsEffect & { resolved: (playerName: string) => string };
}
...
export const EVENTS: EventDef[] = [
  {
    ...
    auto: {
      ...
      moodDelta: -8,
      resolved: () =>
        `He'll spend 4 weeks in a bio-lab tank while the new arm comes in. The replacement ships factory-fresh — no muscle memory included.`,
    },
  },
  {
    id: 'holiday',
    ...
    choices: [
      {
        ...
        effect: { integrityDelta: 5, outWeeks: 1, outReason: 'home for the festival' },
        gambleDelay: 1,
        gamble: [
          {
            weight: 2,
          ...
          },
          {
            ...
            effect: { moodDelta: -8, statDeltas: { men: -3 } },
          },
          {
            weight: 3,
          ...
          },
          {
            ...
            effect: { statDeltas: { phy: 4 }, moodDelta: 8 },
          },
          {
            weight: 1,
            ...
            effect: { statDeltas: { off: 5 }, moodDelta: 5 },
          },
        ],
      },
      {
        ...
        gamble: [
          {
            ...
            effect: { statDeltas: { phy: 3, def: 3 }, weightDelta: 6 },
          },
          {
            weight: 2,
    ...
    choices: [
      {
        ...
        effect: { integrityDelta: 10, outWeeks: 3, outReason: 'academic exchange', moodDelta: 10, statDeltas: { men: 3 } },
      },
      {
    ...
    choices: [
      {
        ...
        effect: { moodDelta: 12, statDeltas: { men: -2 } },
      },
      {
        ...
        effect: { moodDelta: -8, statDeltas: { men: 2 }, integrityDelta: 3 },
      },
    ],
  },
  {
  ...
  },
  {
    ...
    choices: [
      ...
      },
      {
        ...
        effect: { integrityDelta: -9, statDeltas: { off: 3 } },
      },
    ],
  },
];
...
export const SCHMOOZE_METHODS: SchmoozeDef[] = [
  {
    ...
    riskPct: 25,
    riskText: (p) =>
      `League snoops photograph you and ${p} splitting the flambéed comet. An inquiry opens, the maître d' sells the holos, and the league slaps a NO-CONTACT ORDER on ${p}.`,
    riskIntegrity: -8,
    riskHalvesGain: true,
    riskBanWeeks: 2,
  },
