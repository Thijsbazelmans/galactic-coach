...
// ---- THE BAG (items) --------------------------------------------------------
// context = where the slot pulses; target 'player' = draggable onto a card.
const ITEMS = [
  { id: 'vial', name: "BEELZEBUB'S VIAL", short: 'VIAL', rarity: 'rare', context: ['injury', 'pregame'], target: 'player', flavor: '"One sip. Ask nothing." — the doctor on stAroid-5', effect: '100% back on his feet tonight, full energy', up: '2% BREAKTHROUGH', down: '25% INJURY', out: { up: 'Whatever was wrong is gone — and something extra came with it. (+2 attr pts)', mid: 'He shudders once and stands up like nothing ever happened. You ask nothing.', down: 'INCREDIBLE for six hours; then his legs stop answering. 3 weeks in the medbay, −1 level. The team doctor won\'t even look at you.' } },
  { id: 'xarter', name: "XARTER'S INVITATION", short: 'XART', rarity: 'legendary', context: ['practice'], flavor: 'The mind-controlling trainer takes one pupil a year.', effect: 'a level, instantly, and a body rebuilt for speed', up: '5% BREAKTHROUGH', down: '10% SCANDAL', out: { up: 'His first step now happens slightly before he decides to take it. (+1 level, +2 ATH, +2 more)', mid: 'Faster, quieter, and unwilling to discuss it. (+1 level, +2 ATH)', down: 'Wrong behind the eyes: mid-scrimmage he bites a teammate\'s leg. Suspension + a league file with your name on it. (+2 FRC, −2 BRN, 3w out, +15 heat)' } },
  { id: 'chrono', name: 'CHRONO SIP', short: 'CHRNO', rarity: 'legendary', context: ['practice'], flavor: 'Time is a liquid if you know the right bartender.', effect: 'three levels of growth, instantly', up: '2% BREAKTHROUGH', down: '10% DRAMA', out: { up: 'Three years of work in his hands — and a ceiling you can no longer see. (+3 levels, +8 potential)', mid: 'Three subjective years of empty-gym reps land in his body at once. He sits down for a while. (+3 levels)', down: 'He also AGES three subjective years. The registrar says that\'s a class year. (+3 levels, then the REGISTRAR beat)' } },
  { id: 'icepack', name: 'METEOR ICE PACK', short: 'ICE', rarity: 'common', context: ['injury'], target: 'player', flavor: 'Cold from before the solar system. The honest one.', effect: 'recovery time halved', up: '2% SPIRIT', down: '2% DRAIN', out: { mid: 'The meteor ice does its ancient work: N weeks → ceil(N/2).' } },
  { id: 'espresso', name: 'NEBULA ESPRESSO', short: 'ESPR', rarity: 'common', context: ['pregame'], flavor: 'Brewed under pressure. Like everyone here.', effect: 'squad +20 energy tonight, −30 crash next week', up: '2% SPIRIT', down: '2% DRAMA', out: { mid: 'Pupils the size of moons. Tonight they are LIMITLESS. Next week is next week. (THE CRASH scheduled)' } },
  { id: 'karaoke', name: 'MOOD KARAOKE CHIP', short: 'KARA', rarity: 'common', context: ['mood', 'practice'], flavor: 'Contains every power ballad ever written, in every language, at once.', effect: 'squad mood +15', up: '5% SPIRIT', down: '2% DRAMA', out: { up: 'Three-part harmony. Someone cries. The team leaves as brothers. (+25)', mid: 'Off-key, off the rails, exactly right. (+15)', down: 'Someone hogs the mic for two straight hours and the room turns on him. (+8 team, −10 him)' } },
  { id: 'hologram', name: 'STUDY-BUDDY HOLOGRAM', short: 'HOLO', rarity: 'common', context: ['academic'], flavor: 'A tutor of light. Extremely thorough. Slightly too thorough.', effect: 'he passes', up: '2% BREAKTHROUGH', down: '10% SCANDAL', out: { up: 'Something CLICKS. He aces it — and his game IQ came along. (+2 BRN, +8 mood)', mid: 'He passes. The hologram bows and folds itself into a point of light.', down: 'The hologram SAT THE EXAM ITSELF wearing his face. It scored a perfect 100, which was the giveaway. (+15 heat, 1w hearing)' } },
  { id: 'vip', name: 'KAPPA NEBULA VIP PASS', short: 'VIP', rarity: 'rare', context: ['recruiting'], flavor: 'Laminated. Glowing. Slightly sticky.', effect: 'a recruit falls in love with campus: commitment +25%', up: '5% INTEL', down: '25% DRAMA', out: { up: 'He plays pickup at 3am while your assistant takes notes. +25% AND fully revealed.', mid: 'He leaves wearing one of your team caps. (+25%)', down: 'The VIP night ends in a brawl over somebody\'s cheerleader girlfriend. (−20%)' } },
  ...
  { id: 'protein', name: 'PROTO-PROTEIN BARS', short: 'BARS', rarity: 'common', context: ['practice', 'pregame'], flavor: 'Tastes like drywall. Works like a miracle.', effect: 'squad energy +8', out: { mid: 'The squad chews through the crate with the joyless efficiency of professionals. Legs feel new.' } },
  { id: 'poster', name: 'SIGNED LEGEND POSTER', short: 'POSTR', rarity: 'common', context: ['mood', 'practice'], flavor: 'A holo-poster of the greatest to ever do it, signed in three dimensions.', effect: 'squad mood +10', out: { mid: 'Everyone pretends not to look at it. Everyone looks at it.' } },
  { id: 'alarm', name: 'FIRE ALARM CODES', short: 'ALARM', rarity: 'rare', context: ['pregame'], flavor: "The access codes to the visitors' hotel fire panel. You didn't buy these. Officially.", effect: 'their hotel evacuates at 3am — they play tired', up: '2% WINDFALL', down: '25% SCANDAL', out: { up: 'It fires THREE times. Their star spends the night on the curb in a blanket. You feel bad. You feel great.', mid: 'The alarm sings at 3am. Tonight their legs answer half a beat late.', down: 'So does the hotel security cam feed, straight to the league office. (+15 heat)' } },
  { id: 'seer', name: "THE SEER'S LENS", short: 'LENS', rarity: 'rare', context: ['recruiting'], flavor: 'Ground from the eye of a dead comet. Shows only true things.', effect: 'one unknown prospect: fully revealed', out: { mid: 'A random un-fully-known prospect resolves into perfect focus — every number, every ceiling, true.' } },
  { id: 'check', name: "BOOSTER'S BLANK CHECK", short: 'CHECK', rarity: 'rare', context: ['recruiting'], flavor: 'The amount is blank. The strings are not.', effect: 'a prospect signs. Today.', up: '2% LOOT', down: '25% SCANDAL', out: { mid: 'He signs on the spot. The booster winks at you across the parking lot for an uncomfortably long time.', down: 'So does the check — into a league evidence folder. THE SUBPOENA lands in 4 weeks. (+20 heat)' } },
  // the supply-closet drip (small, meant to be SPENT)
  { id: 'patch', name: 'PATCH KIT', short: 'PATCH', rarity: 'common', supply: true, context: ['injury'], target: 'player', flavor: 'Tape, spray, and a lie about how bad it looked.', effect: 'a 1-week knock, gone', out: { mid: 'Tape, spray, done. He jogs it off like it never happened. (only works on exactly 1w)' } },
...
const SUPPLY_DRIP = ['patch', 'juice', 'cocoa', 'pass', 'protein', 'poster'];
...
const CONSTANTS = [
  ...
  ['THE SLIDE', 'conference AI floors 62/55/49/44/38 (reshuffled every summer, settled to tier) · you start ~47 (4th–5th) · THE BIG BANG: first round 65–75 · semi 70–80 · final 75–85 — fixed, never sized to you'],
